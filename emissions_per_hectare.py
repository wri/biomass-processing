...
def biomass_to_emissions_ha(tile_id, out_dir, max_year):
    ...
    loss_tile = 'GFW{0}_{1}.tif'.format(max_year, tile_id)

    # Output file name
    outname = '{0}_Mg_CO2_ha_AGB_masked_by_loss_{1}.tif'.format(tile_id, max_year)
    ...
    print "Masking tile", tile_id, "by loss pixels and converting from Mg biomass to Mg CO2..."
